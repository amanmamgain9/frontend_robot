...
return (new CustomEvent(event_name,(function (){var obj29430 = ({"detail":data});
return obj29430;
})()));
} else {
...
var expr__29438 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
...
return console.warn(p1__29431_SHARP_);
});
} else {
...
return console.debug(p1__29432_SHARP_);
});
} else {
...
return console.error(p1__29433_SHARP_);
});
} else {
return (function (p1__29434_SHARP_){
return console.log(p1__29434_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29441){
...
var opts = map__29442__$1;
var eval_fn = cljs.core.get.call(null,map__29442__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__29444_SHARP_){
return new_def.callback(p1__29444_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__29445){
var vec__29446 = p__29445;
var ky = cljs.core.nth.call(null,vec__29446,(0),null);
var v = cljs.core.nth.call(null,vec__29446,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1577462217402
