...
}catch (e25576){var _e = e25576;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___25579 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___25579)){
var seen_errors_25580 = temp__5733__auto___25579;
if(cljs.core.truth_(seen_errors_25580.has(self))){
} else {
seen_errors_25580.add(self);

var temp__5735__auto___25581 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___25581)){
var sense_25582 = temp__5735__auto___25581;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_25582)].join(''));
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1577462212646
