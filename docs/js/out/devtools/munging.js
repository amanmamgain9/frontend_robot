...
var o22956 = temp__5733__auto__;
var temp__5733__auto____$1 = (o22956["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o22957 = temp__5733__auto____$1;
return (o22957["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22060__auto__ = f;
return (o__22060__auto__["toString"]).call(o__22060__auto__);
} else {
return "";
}
}catch (e22958){var _ = e22958;
return "";
}});
...
try{var o__22060__auto___22960 = t;
(o__22060__auto___22960["cljs$lang$ctorPrWriter"]).call(o__22060__auto___22960,t,writer);
}catch (e22959){var __22961 = e22959;
}
...
var char_code = (function (){var o__22060__auto__ = (new String(char$));
return (o__22060__auto__["charCodeAt"]).call(o__22060__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22060__auto__ = String;
return (o__22060__auto__["fromCharCode"]).call(o__22060__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22962 = num_code;
switch (G__22962) {
case (1):
return (185);
...
var o__22060__auto__ = String;
return (o__22060__auto__["fromCharCode"]).call(o__22060__auto__,superscript_code);
});
/**
...
}catch (e22964){var _e__22067__auto__ = e22964;
return false;
}})())){
...
var vec__22965 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22965,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o22968 = temp__5733__auto__;
var temp__5733__auto____$1 = (o22968["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o22969 = temp__5733__auto____$1;
return (o22969["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22972){
var vec__22973 = p__22972;
var ns_detector = cljs.core.nth.call(null,vec__22973,(0),null);
...
var G__22979 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22980 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22979;
remaining_tokens = G__22980;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22970){
var G__22971 = cljs.core.first.call(null,seq22970);
var seq22970__$1 = cljs.core.next.call(null,seq22970);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22971,seq22970__$1);
}));
...
var vec__22984 = cljs.core.split_with.call(null,(function (p1__22983_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22983_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22984,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22984,(1),null);
...
var vec__22990 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22990,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22990,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22993 = cljs.core.rest.call(null,remaining_tokens);
var G__22994 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22993;
name_tokens = G__22994;
continue;
} else {
...
var vec__22997 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22997,(0),null);
var arity = cljs.core.nth.call(null,vec__22997,(1),null);
var vec__23000 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23000,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23000,(1),null);
var vec__23003 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23003,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23003,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23003,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23003,(3),null);
...
var vec__23009 = result;
var munged_ns = cljs.core.nth.call(null,vec__23009,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23009,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23009,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23009,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23009,(4),null);
var arity = cljs.core.nth.call(null,vec__23009,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__23013 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__23013,(0),null);
var args = cljs.core.nth.call(null,vec__23013,(1),null);
var vec__23016 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23016,(0),null);
var name = cljs.core.nth.call(null,vec__23016,(1),null);
...
var G__23019 = (arity + (1));
var G__23020 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23021){
var vec__23022 = p__23021;
var arity = cljs.core.nth.call(null,vec__23022,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23022,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__23025_SHARP_){
return cljs.core.get.call(null,arities,p1__23025_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__23026_SHARP_){
return cljs.core.drop.call(null,(2),p1__23026_SHARP_);
}),sorted_infos);
...
var args__4795__auto__ = [];
var len__4789__auto___23033 = arguments.length;
var i__4790__auto___23034 = (0);
while(true){
if((i__4790__auto___23034 < len__4789__auto___23033)){
args__4795__auto__.push((arguments[i__4790__auto___23034]));

var G__23035 = (i__4790__auto___23034 + (1));
i__4790__auto___23034 = G__23035;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23029){
var vec__23030 = p__23029;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23030,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23027){
var G__23028 = cljs.core.first.call(null,seq23027);
var seq23027__$1 = cljs.core.next.call(null,seq23027);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23028,seq23027__$1);
}));
...
var G__23036 = arg;
var G__23036__$1 = (((G__23036 instanceof cljs.core.Keyword))?G__23036.fqn:null);
switch (G__23036__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23038__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23038__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23038__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23038__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23039 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23039,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23039,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23039,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23039,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23039,(4),null);
var arity = cljs.core.nth.call(null,vec__23039,(5),null);
...
var o__22060__auto__ = f;
return (o__22060__auto__["getBasis"]).call(o__22060__auto__);
});
/**
...
}catch (e23043){var _e__22067__auto__ = e23043;
...
var G__23044 = (obj[cljs.core.first.call(null,path)]);
var G__23045 = cljs.core.rest.call(null,path);
obj = G__23044;
path = G__23045;
continue;
} else {
...
var _STAR_ = (function (accum,p__23046){
var vec__23047 = p__23046;
var bit = cljs.core.nth.call(null,vec__23047,(0),null);
var protocol = cljs.core.nth.call(null,vec__23047,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23050){
var vec__23051 = p__23050;
var ns = cljs.core.nth.call(null,vec__23051,(0),null);
var name = cljs.core.nth.call(null,vec__23051,(1),null);
var selector = cljs.core.nth.call(null,vec__23051,(2),null);
...
var post_process = (function (p__23055){
var vec__23056 = p__23055;
var munged_name = cljs.core.nth.call(null,vec__23056,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23056,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__23054_SHARP_){
return (obj[cljs.core.first.call(null,p1__23054_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1577462206533
