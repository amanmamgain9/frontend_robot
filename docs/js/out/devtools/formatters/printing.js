...
var len__4789__auto___23090 = arguments.length;
var i__4790__auto___23091 = (0);
while(true){
if((i__4790__auto___23091 < len__4789__auto___23090)){
args__4795__auto__.push((arguments[i__4790__auto___23091]));

var G__23092 = (i__4790__auto___23091 + (1));
i__4790__auto___23091 = G__23092;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23087){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23088,G__23089,seq23087__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23093_SHARP_){
return (!((cljs.core.meta.call(null,p1__23093_SHARP_) == null)));
})))){
...
var map__23094 = opts;
var map__23094__$1 = (((((!((map__23094 == null))))?(((((map__23094.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23094.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23094):map__23094);
var markup_db = cljs.core.get.call(null,map__23094__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23098){var _e__22067__auto__ = e23098;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e23100){var _e__22067__auto__ = e23100;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__23102 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23103 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23103);

try{var map__23104 = opts;
...
var markup_db = cljs.core.get.call(null,map__23104__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23102);
}});
...
var temp__5733__auto___23109 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___23109)){
var managed_print_level_23110 = temp__5733__auto___23109;
var _STAR_print_level_STAR__orig_val__23107_23111 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23108_23112 = managed_print_level_23110;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23108_23112);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__23106_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__23106_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23107_23111);
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1577462206867
