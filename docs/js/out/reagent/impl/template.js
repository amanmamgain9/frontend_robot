...
var G__25204 = o;
goog.object.set(G__25204,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__25206__i < G__25206__a.length) {G__25206__a[G__25206__i] = arguments[G__25206__i + 0]; ++G__25206__i;}
  args = new cljs.core.IndexedSeq(G__25206__a,0,null);
} 
...
var args = cljs.core.seq(arglist__25207);
...
var G__25208 = o;
goog.object.set(G__25208,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__25210__i < G__25210__a.length) {G__25210__a[G__25210__i] = arguments[G__25210__i + 0]; ++G__25210__i;}
  args = new cljs.core.IndexedSeq(G__25210__a,0,null);
} 
...
var args = cljs.core.seq(arglist__25211);
...
var G__25212 = props;
var G__25212__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__25212,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__25212);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__25212__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__25212__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__25213 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__25213,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__25213;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__25214){
...
var on_write = cljs.core.get.call(null,map__25215__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__25217_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25217_SHARP_);
}));
} else {
return null;
}
...
var vec__25220 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25220,(0),null);
var id = cljs.core.nth.call(null,vec__25220,(1),null);
var className = cljs.core.nth.call(null,vec__25220,(2),null);
...
var temp__5739__auto___25224 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___25224 == null)){
} else {
var key_25225 = temp__5739__auto___25224;
(jsprops.key = key_25225);
}
...
var temp__5739__auto___25226 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___25226 == null)){
} else {
var key_25227 = temp__5739__auto___25226;
(jsprops.key = key_25227);
}
...
var temp__5739__auto___25228 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___25228 == null)){
} else {
var key_25229 = temp__5739__auto___25228;
(jsprops.key = key_25229);
}
...
var G__25231 = n;
if(cljs.core._EQ_.call(null,"",G__25231)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__25231)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq25232){
var G__25233 = cljs.core.first.call(null,seq25232);
var seq25232__$1 = cljs.core.next.call(null,seq25232);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25233,seq25232__$1);
}));
...
break;
default:
var G__25239 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__25239;
continue;
...
var ctx = ({});
var vec__25241 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__25241,(0),null);
var derefed = cljs.core.nth.call(null,vec__25241,(1),null);
...
var G__25244 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25244) {
case (0):
...
//# sourceMappingURL=template.js.map?rel=1577462211875
